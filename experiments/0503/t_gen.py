...
if __name__ == "__main__":
    ...
    for _bs in [8, 32, 64]:
        scripts.append(generate(gpu,_bs,warmup,epochs,h,d_model,d_ff,dp,n,seq_len, use_pose))

    for _d_ff in [1024, 2048]:
        scripts.append(generate(gpu,bs,warmup,epochs,h,d_model,_d_ff,dp,n,seq_len,use_pose))
