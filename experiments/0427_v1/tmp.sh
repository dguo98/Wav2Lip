...
TEST_DATA=${BASE_DIR}/data/p_words/p_train
...
#    --N ${N} --d_ff ${D_FF} --d_model ${D_MODEL} --h ${H} --mode quick \
...
CUDA_VISIBLE_DEVICES=${GPU} python get_video_from_latents.py --input ${LOG_DIR}/inference --fps 29.97
#rm ${LOG_DIR}/inference/*.pt
#rm ${LOG_DIR}/inference/*.jpg

#CUDA_VISIBLE_DEVICES=${GPU} python get_video_from_latents.py --input ${LOG_DIR}/tf_inference --fps 29.97
