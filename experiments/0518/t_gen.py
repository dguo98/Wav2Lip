...
if __name__ == "__main__":
    ...
    # mouth pixel + latent loss
    for _img_loss in [0.2, 0.5]:
        for _bs in [8]:
            scripts.append(generate(gpu,_bs,warmup,epochs,h,d_model,d_ff,dp,n,seq_len, use_pose,img_type,_img_loss,img_mouth, lmk_loss, perc_loss))
