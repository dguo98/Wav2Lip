...
if __name__ == "__main__":
    ...
    for _img_mouth in [1, 0]:
        for _template in ["lmk"]:
            for _epochs, _lmk_loss in [(1,1.0), (1,0.5)]:
                scripts.append(generate(gpu,bs,warmup,_epochs,h,d_model,d_ff,dp,n,seq_len, use_pose,_template,img_type,img_loss,_img_mouth, _lmk_loss, perc_loss))
