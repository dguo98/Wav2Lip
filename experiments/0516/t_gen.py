...
def generate(gpu, bs,warmup,epochs,h,d_model,d_ff,dp,n,seq_len,use_pose,
    img_type, img_loss, img_mouth, lmk_loss, perc_loss):
    global expid
    expid += 1
...
if __name__ == "__main__":
    ...
    scripts=[]
    for _img_loss in [0.4, 0.6]:
        for _perc_loss in [0.0, 0.1]:
            scripts.append(generate(gpu,bs,warmup,epochs,h,d_model,d_ff,dp,n,seq_len, use_pose,img_type,_img_loss,img_mouth, lmk_loss, _perc_loss))
