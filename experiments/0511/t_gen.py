...
def generate(gpu, bs,warmup,epochs,h,d_model,d_ff,dp,n,seq_len,use_pose,
    template, img_type, img_loss, img_mouth):
    global expid
    expid += 1
...
if __name__ == "__main__":
    ...
    for _img_mouth in [0, 1]:
        scripts.append(generate(gpu,bs,warmup,epochs,h,d_model,d_ff,dp,n,seq_len, use_pose,template,img_type,img_loss,_img_mouth))
